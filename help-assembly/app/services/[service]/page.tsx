...
export async function generateMetadata({
  ...
  return {
    title: `${title} in Atlanta | Same-Day Service`,
    ...
    <main className="min-h-screen bg-[#F0F0F3] pb-32 pt-20">
      ...
      <section className="py-8 px-6 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-xs font-semibold tracking-widest uppercase text-[#C59E37] mb-3">Why Choose Us</p>
          <h2 className="font-display font-bold text-3xl lg:text-4xl">
            The Best <span className="text-[#D90429]">{serviceName}</span> in Atlanta
          </h2>
        </div>

        <div className="bg-[#F0F0F3] rounded-3xl p-8 lg:p-12 mb-8
                        shadow-[16px_16px_40px_#D1D1D4,-16px_-16px_40px_#FFFFFF]">
          <div className="space-y-5 text-gray-600 leading-relaxed text-base">
            <p>
              When you need professional <strong className="text-[#111111]">{serviceName.toLowerCase()}</strong>, you
              shouldn&apos;t have to wait weeks or deal with unpredictable arrival windows. Help Assembly Services LLC
              delivers a premium, white-glove experience powered by cutting-edge logistics.
            </p>
            <p>
              Our technicians are fully equipped to handle projects of any complexity. We service the entire Atlanta
              metro area — from Buckhead to Marietta — ensuring your installation is completed perfectly the first time.
            </p>
          </div>
          ...
          <ul className="mt-8 space-y-3">
            {checklist.map((item) => (
              <li key={item} className="flex items-start gap-3">
                <span className="mt-0.5 w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 mb-8 text-lg">Same-day slots are limited. Secure yours now.</p>
